...
#define STRING_CONFIG_H_AUTHOR "(Simple Pro Custom)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 66.88
  #define DEFAULT_bedKi 12.10
  #define DEFAULT_bedKd 246.38
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 404.08, 403.28, 1592.88, 124.6 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 404.08, 403.28, 1592.88, 46.3 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1200, 1200, 3, 25 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 10, 600 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - (MIN_PROBE_EDGE * 2))
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - 20
  #define FRONT_PROBE_BED_POSITION MIN_PROBE_EDGE
  //#define BACK_PROBE_BED_POSITION (Y_BED_SIZE - (MIN_PROBE_EDGE * 4))
